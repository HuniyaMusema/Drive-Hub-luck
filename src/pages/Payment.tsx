    ...
    <PageShell>
      <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
        ...
        <div className="animate-fade-in-up">
          ...
          <p className="text-muted-foreground mb-8">Upload your payment receipt to confirm your purchase or lottery entry.</p>

          {/* Upload form */}
          <div className="bg-card rounded-xl shadow-sm p-6 mb-10">
            <h2 className="font-semibold text-card-foreground mb-4">Submit Payment Receipt</h2>
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button type="submit" size="lg" className="w-full">Submit Receipt</Button>
            </form>
          </div>
