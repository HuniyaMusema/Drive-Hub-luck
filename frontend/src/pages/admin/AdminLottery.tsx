          ...
          <div className="p-8">
            {lotteryLoading ? (
              ...
              <form className="space-y-6" onSubmit={handleStart}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="h-14 w-full flex items-center bg-slate-100 border border-slate-200 rounded-2xl px-5 font-black text-slate-400 tabular-nums text-base select-none">
                        1
                      </div>
                    </div>
                    <div>
                ...
                {/* Ticket Price */}
                <div className="space-y-3">
                  <Label className="text-[10px] uppercase tracking-[0.2em] font-black text-slate-500 ml-1">Ticket Price</Label>
