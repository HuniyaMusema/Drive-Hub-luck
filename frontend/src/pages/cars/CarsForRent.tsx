  ...
  return (
    <PageShell>
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-8">
          <p className="text-accent font-semibold text-sm uppercase tracking-widest mb-2">{t("rentals") || "Rentals"}</p>
        ...
        <div className="flex flex-wrap items-center gap-3 mb-8">
          <div className="relative flex-1 min-w-[200px] max-w-md">
            ...
            <input 
              type="text"
              placeholder={t("searchRentals") || "Search rentals..."} 
        ...
        {showFilters && (
          <div className="mb-8 p-4 bg-card rounded-xl shadow-sm animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {brands.filter(b => carsData.some(c => c.type === "rental" && c.brand === b)).map((b) => (
                <button
                  key={b}
